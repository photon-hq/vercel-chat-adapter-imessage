...
| `webhookVerifier` | No | Sync or async trusted-forwarder verifier `(request, rawBody)`. Takes precedence over `webhookSecret`; throw or return a falsy value to reject. |
